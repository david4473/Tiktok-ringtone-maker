          ...
          <div className="space-y-6 text-sm leading-7 text-[var(--tone-ink-soft)]">
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                audio complies with applicable copyright, licensing, and platform
                rules. Do not use this site to infringe the rights of others.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                may vary depending on the source content, network conditions, and
                device environment.
              </p>
            </div>
